...
#ifdef NDEBUG
const char*	   ProgramName="CO-EVOLUTION wersja 2.99 (c)1994-2004: Wojciech Borkowski [idea i realizacja]";
#else
const char*	   ProgramName="CO-EVOLUTION wersja 2.99DEBUG (c)1994-2004 Wojciech Borkowski";
#endif
const char*    SCREENDUMPNAME="CO-EVO-2.995b";
...
GT_filter<method_matrix_source<agent,bool> >* filtrZycia=//Filtr na "Tylko Zywe"
	new GT_filter<method_matrix_source<agent,bool> >(0.5,Zycie,DEFAULT_MISSING,"Zywe");//
...
//Energia
pom=new carpet_graph(Menager.getwidth()-80,87+21+1+21+21,Menager.getwidth()-1,87+21+1+21+21+21,					                   
...
graph* pom1=new sequence_graph(
                               ...
                               szer_map,300,Menager.getwidth()-1,400,//rownolegle do okna liczby taksonow
...
pom1=new sequence_graph(//szer_map,300,szer_map+300,400,
                        Menager.getwidth()-80,87+21+1,Menager.getwidth()-1,87+21+21,//domyslne wspolrzedne
							    3,Sources.make_series_info(
...
pom=new carpet_graph(Menager.getwidth()-80,87+21+1+21+21+21,Menager.getwidth()-1,87+21+1+21+21+21+21,//domyslne wspolrzedne
                     //Menager.getwidth()-80,87+21+1+21+21,Menager.getwidth()-1,87+21+1+21+21+21,					
...
pom1=new sequence_graph(//szer_map+301,300,Menager.getwidth()-1,400,
                        Menager.getwidth()-80,199,Menager.getwidth()-1,299,//domyslne wspolrzedne						
...
OutArea=new text_area(
                      szer_map+1,0,Menager.getwidth()-81,87+21+21,//domyslne wspolrzedne
                      "Information area",
