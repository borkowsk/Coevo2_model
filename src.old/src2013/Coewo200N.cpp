/* Program symulujący KOEWOLUCJĘ (Wersja z roku 2013)*/
...
//Wersja 3.5
//Uporządkowanie liczników kroków - przejście na kroki Monte-Carlo tam gdzie się da...
...
//od aktualnej multiplikacji MC. Ale w pliku log jest seria z właściwymi wartościami MC
...
//4. 25.04.08 Usunięcie błędu w bibliotecznym menagerze lufcików wywalającego program przy robieniu TILE
...
//9. Regulacja częstość zrzutów - NIEDOKOŃCZONA - POWODUJE BŁĘDNĄ NUMERACJE PLIKÓW I KROKÓW

//Istotne nowosci w wersji 2.5
//1. Odwrotność prawdopodobieństwa mutacji wyprowadzona jako parametr RTG
//Mutacje w okolicy 1/16000 dla obszary 400x200 doprowadzają do wyparcia heterotrofów 70000:100
//i to przy rożnych wartościach globalności oddziaływań.
...
//Ma ono zapobiegać formowaniu sie frontów - czyli blokowaniu rozprzestrzeniania sie skutecznych taksonów przez 'gęstość zaludnienia'
//3. Wprowadzenie maksymalnego dystansu skoku pozwala zbadać zależność od 'globalności ekologii'
//4. Dodano tez wyświetlanie wieku taksonów
...
//6. Nieco uelastyczniono sposób ustalania co jest klonem a co taksonem - treshold jest teraz zmienna
...
//Menager lufcików ze uzupełniona obsługa i/o (z menu)
...
wb_pchar buf(1024);
buf.prn(lang("FILOGENEZA - taksony powy¿ej %d agentów",
...
for(int i=1;i<argc;i++)
	...
	cerr<<"===================================================================="<<endl;
	cerr<<lang("MOZLIWE TO: (W nawiasach wartoœci domyœlne)",
	...
	cerr<<lang("IFER=NN - prawdopodobieñstwo rozmnażania to. 1/IFER = 1/",
	...
	cerr<<lang("MAXA=nnn - maksymalny wiek. Nie wiêkszy niż 255. ",
			   "MAXA=nnn - maximal age. Not grater than 255. ")<<'('<<255-MINIMALNY_WIEK<<')'<<endl;// Ujemne BÊDZIE oznaczaæ œmierci losowe"<<'('<<xxx<<')'<<endl;//const unsigned	MINIMALNY_WIEK=205;	// Rodzi sie z tym wiekiem. Do smierci ma 255-MINIMALNY_WIEK
